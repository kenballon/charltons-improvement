    ...
    <div class="<?php echo esc_attr(implode(' ', $container)); ?>">
        ...
        <p class="et_post_bg_color_setting et_divi_format_setting et_pb_page_settings">
            <input id="et_post_bg_color" name="et_post_bg_color" class="color-picker-hex" type="text" maxlength="7"
                placeholder="<?php esc_attr_e('Hex Value', 'Divi'); ?>" value="<?php echo esc_attr($post_bg_color); ?>"
...
if (!function_exists('et_divi_customizer_theme_settings')):
	...
	function et_divi_customizer_theme_settings($wp_customize) {
		...
		$wp_customize->add_setting(
			...
			array(
				'default' => absint(et_get_option('body_header_size', '30')) * 0.6,
				'type' => 'option',
				'capability' => 'edit_theme_options',
				'transport' => 'postMessage',
				'sanitize_callback' => 'absint',
...
if (class_exists('WP_Customize_Control')) {
    ...
    <?php
			...
			foreach ($this->choices as $value => $label):
				...
				?>
    <span class="et_font_style et_font_value_<?php echo esc_attr($value);
				echo $checked_class; ?>">
...
function et_divi_add_customizer_css()
{
	...
	$widget_header_font_size = intval(et_get_option('widget_header_font_size', $body_header_size * 0.6));
	...
	ob_start();
        ...
        .et_secondary_nav_enabled #page-container #top-header { background-color:
        <?php echo esc_html($secondary_nav_bg) . ' !important'; ?>; }
        ...
        <?php } ?>
        <?php if (intval($body_header_size * 0.6) !== $widget_header_font_size) { ?>
        #main-footer .footer-widget h4,
        #main-footer .widget_block h1,
        #main-footer .widget_block h2,
        #main-footer .widget_block h3,
        ...
        <?php echo esc_html(round($menu_height * 0.18)); ?>px; }
        ...
        <?php echo esc_html($menu_height * 0.18); ?>px; }
        <?php } ?>
        ...
        .et_fixed_nav #page-container .et-fixed-header#top-header { background-color:
        <?php echo esc_html($fixed_secondary_nav_bg); ?> !important; }
        .et_fixed_nav #page-container .et-fixed-header#top-header #et-secondary-nav li ul { background-color:
        ...
        .et-fixed-header #top-menu li.current_page_item > a { color: <?php echo esc_html($fixed_menu_link_active); ?>
        !important; }
        <?php } ?>
        ...
        font-size: <?php echo esc_html(intval($body_header_size * 0.86)); ?>px;
        }
        <?php echo $css('h3'); ?> {
        font-size: <?php echo esc_html(intval($body_header_size * 0.73)); ?>px;
        }
        <?php echo $css('h4'); ?>,
        ...
        font-size: <?php echo esc_html(intval($body_header_size * 0.6)); ?>px;
        }
        <?php echo $css('h5'); ?> {
        font-size: <?php echo esc_html(intval($body_header_size * 0.53)); ?>px;
        }
        <?php echo $css('h6'); ?> {
        font-size: <?php echo esc_html(intval($body_header_size * 0.47)); ?>px;
        }
        <?php echo $css('.et_pb_slide_description .et_pb_slide_title', false); ?> {
        ...
        <?php } ?>
        <?php if ($body_font_size !== $tablet_body_font_size) { ?>
        <?php echo esc_html($body_selector_sibling); ?>
        <?php echo esc_html($body_selector); ?>,
        <?php echo $css('.et_pb_column_1_2 .et_quote_content blockquote cite', false); ?>,
        <?php echo $css('.et_pb_column_1_2 .et_link_content a.et_link_main_url', false); ?>,
        ...
        <?php echo $css('.product .related h2'); ?>,
        <?php echo $css('.et_pb_column_1_2 .et_quote_content blockquote p', false); ?> {
        font-size: <?php echo esc_html(intval($tablet_header_font_size * 0.86)); ?>px;
        }
        <?php echo $css('h3'); ?> {
        font-size: <?php echo esc_html(intval($tablet_header_font_size * 0.73)); ?>px;
        }
        ...
        <?php echo $css('.et_pb_portfolio_grid .et_pb_portfolio_item h2', false); ?>,
        <?php echo $css('.et_pb_filterable_portfolio_grid .et_pb_portfolio_item h2', false); ?> {
        font-size: <?php echo esc_html(intval($tablet_header_font_size * 0.6)); ?>px;
        }
        ...
        <?php echo $css('.et_pb_filterable_portfolio_grid .et_pb_portfolio_item h2', false); ?>,
        <?php echo $css('.et_pb_column_1_4 .et_pb_audio_module_content h2', false); ?> {
        font-size: <?php echo esc_html(intval($tablet_header_font_size * 0.53)); ?>px;
        }
        <?php echo $css('h5'); ?> {
        font-size: <?php echo esc_html(intval($tablet_header_font_size * 0.53)); ?>px;
        }
        <?php echo $css('h6'); ?> {
        font-size: <?php echo esc_html(intval($tablet_header_font_size * 0.47)); ?>px;
        }
        <?php } ?>
        ...
        <?php if ($phone_body_font_size !== $tablet_body_font_size) { ?>
        <?php echo esc_html($body_selector_sibling); ?>
        <?php echo esc_html($body_selector); ?>,
        <?php echo $css('.et_pb_column_1_2 .et_quote_content blockquote cite', false); ?>,
        <?php echo $css('.et_pb_column_1_2 .et_link_content a.et_link_main_url', false); ?>,
        ...
        <?php echo $css('.product .related h2'); ?>,
        <?php echo $css('.et_pb_column_1_2 .et_quote_content blockquote p', false); ?> {
        font-size: <?php echo esc_html(intval($phone_header_font_size * 0.86)); ?>px;
        }
        <?php echo $css('h3'); ?> {
        font-size: <?php echo esc_html(intval($phone_header_font_size * 0.73)); ?>px;
        }
        <?php echo $css('h4'); ?>,
        <?php echo $css('.et_pb_circle_counter h3', false); ?>,
        <?php echo $css('.et_pb_number_counter h3', false); ?>,
        ...
        <?php echo $css('.et_pb_portfolio_grid .et_pb_portfolio_item h2', false); ?>,
        <?php echo $css('.et_pb_filterable_portfolio_grid .et_pb_portfolio_item h2', false); ?> {
        font-size: <?php echo esc_html(intval($phone_header_font_size * 0.6)); ?>px;
        }
        <?php echo $css('.et_pb_slider.et_pb_module .et_pb_slides .et_pb_slide_description .et_pb_slide_title', false); ?>
        {
        ...
        <?php echo $css('.et_pb_filterable_portfolio_grid .et_pb_portfolio_item h2', false); ?>,
        <?php echo $css('.et_pb_column_1_4 .et_pb_audio_module_content h2', false); ?> {
        font-size: <?php echo esc_html(intval($phone_header_font_size * 0.53)); ?>px;
        }
        <?php echo $css('h5'); ?> {
        font-size: <?php echo esc_html(intval($phone_header_font_size * 0.53)) ?>px;
        }
        <?php echo $css('h6'); ?> {
        font-size: <?php echo esc_html(intval($phone_header_font_size * 0.47)) ?>px;
        }
        <?php } ?>
						...
						if (in_array($key, $smaller_title_sections)) {
							...
							switch ($key) {
								case 'et_pb_slider-header_font_size':
									$font_size_coefficient = 0.565217391;  // 26/46
									break;

								case 'et_pb_slider-body_font_size':
									$font_size_coefficient = 0.777777778;  // 14/16
									break;

								default:
									$font_size_coefficient = 0.846153846;  // 22/26
									break;
							}
...
function et_customizer_color_scheme_class($body_class)
{
	...
	if ('none' !== $color_scheme)
		$body_class[] = $color_scheme_prefix . $color_scheme;
